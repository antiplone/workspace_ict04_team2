...
public final class Location_APIConfig {
	public static String TOUR_API_KOR_KEY = "?ServiceKey=iT9iBhvgZ32wgE4Y3jGX1MrKqGm2tHBX72Y3BIKN9D57mVnFLFdS7FmG8njDdCgZr3YvY2KBDzpLsK/bxGkFCg==";
		...
		public static Map<String, Object> mapDetailCommon1() {
			return new HashMap<String, Object>() {/**
				...
				private static final long serialVersionUID = 1L;
				{
					...
					put("contentTypeId", Location_APIConfig.TourAPI.Type.valueOfLabel("쇼핑"));
					put("contentId", 2750143);
					put("defaultYN", "Y");
					put("firstImageYN", "Y");
					put("areacodeYN", "Y");
		...
		public static Map<String, Object> mapAreaBasedList1() {
			return new HashMap<String, Object>() {/**
				...
				private static final long serialVersionUID = 1L;
				{
					...
					// areaCode 지역코드 : 화면에서 입력받은 값으로 설정 예정
					// put("areaCode", 32);

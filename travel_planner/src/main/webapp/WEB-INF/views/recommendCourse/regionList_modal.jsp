				        ...
				        <div>
				            <div class="modal-popup-button">
				                <button type="button" class="modal_btn"
				                        data-area-english="${dto.tr_area_english}"
				                        data-area-korea="${dto.tr_area_korea}"
				                        data-area-content="${dto.tr_area_content}"
				                        data-area-image="${dto.tr_area_image}">
				                    <img src="${path}/resources/images/recommendCourse/area/${dto.tr_area_image}.jpg" 
				                         class="area_img" 
				                         alt="${dto.tr_area_english}">
				                </button>
				            </div>
				            <div class="area-english">${dto.tr_area_english}</div>
				            <div class="area-korea">${dto.tr_area_korea}</div>
				        </div>
				    </div>
				</c:forEach>
				        ...
				        <div class="content_box">
				            <div class="content">
				                <div class="areaContent">
				                    <h3 id="modalAreaEnglish"></h3>
				                    <h2 id="modalAreaKorea"></h2>
				                ...
				                <div class="area-detail-image-box">
				                    <img id="modalAreaImage" class="area-detail-image" src="" alt="">
				                </div>
				            </div>
				        </div>

...
CREATE TABLE travel_reviewComment_tbl(
	...
	FOREIGN KEY(rc_num) REFERENCES travel_review_tbl(r_num) ON DELETE CASCADE,
...
-- 댓글 삭제
DELETE FROM travel_reviewComment_tbl
 WHERE rc_num = 28;
COMMIT;
